const config = [
  ...
  { id: 'leuco', label: 'LEUCO', nomesBusca: ["Leucocitos"], ref: { min: 4000, max: 11000 } },
  ...
  { id: 'transferrina', label: 'Transferrina', nomesBusca: ["Transferrina"], ref: { M: { min: 215, max: 365 }, F: { min: 250, max: 380 } } },
  ...
  { id: 'lact', label: 'Lact', nomesBusca: ["Lactato"], regexExclude: 'Arterial', ref: { min: 0.5, max: 2.2 }, trendMeaning: 'higher_is_worse' },
  ...
  { id: 'cea', label: 'CEA', nomesBusca: ["CEA", "Antigeno Carcinoembrionario"], lineStartOnly: true, ref: { min: -Infinity, max: 5.0 }, trendMeaning: 'higher_is_worse' },
